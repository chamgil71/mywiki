...
| 편집 중 메모 | 표시 방법 없음 | `%% ... %%` 주석 |
| 다른 노트 미리보기 | 링크만 가능 | `![노트명](/assets/image/노트명)` 임베드 |
...
graph TD
    ...
    D --> D1["본문: [^1]\n정의: [^1]: 내용"]
    E --> E1["%% 편집자 메모 %%\n읽기 모드에서 숨김"]
    F --> F1["![노트명](/assets/image/노트명)\n![이미지파일](/assets/image/이미지파일)"]
...
```markdown
<!-- 다른 노트 전체를 현재 노트에 포함 -->
![나의 첫 번째 노트](/assets/image/나의 첫 번째 노트)

<!-- 특정 제목 섹션만 포함 -->
![나의 첫 번째 노트#오늘 배운 것](/assets/image/나의 첫 번째 노트#오늘 배운 것)

<!-- 이미지 임베드 (크기 지정 포함) -->
![스크린샷.png](/assets/image/스크린샷.png)
