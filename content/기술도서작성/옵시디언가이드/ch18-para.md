...
| 프로젝트 | 마감 | 상태 | 노트 |
|---|---|---|---|
| [가이드북 집필](/가이드북 집필) | 2024-03-31 | 진행중 | |
...
| 영역 | 이상적 상태 | 현재 상태 |
|---|---|---|
| [건강](/건강) | 주 3회 운동, 체중 65kg 유지 | 주 1회 |
| [커리어](/커리어) | 시니어 개발자, 사이드 프로젝트 운영 | 미드레벨 |
| [재무](/재무) | 비상금 6개월치, 투자 비율 30% | 비상금 3개월 |
| [학습](/학습) | 매월 책 2권, 강의 1개 완료 | 책 1권 |
```
...
## 📝 관련 노트
- [가이드북 목차](/가이드북 목차)
- [집필 스타일 가이드](/집필 스타일 가이드)

## 🗓️ 다음 액션
- [ ] Ch 19 제텔카스텐 초고 작성 (기한: 이번 주)

## 📎 참고 자료
- [옵시디언 공식 문서 메모](/옵시디언 공식 문서 메모)
```
