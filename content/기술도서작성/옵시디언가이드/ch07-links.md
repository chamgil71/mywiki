...
[ch05-markdown-basic#3.3 리스트](/ch05-markdown-basic)
...
② "링크 연습" 노트에서 [나의 첫 번째 노트#오늘 배운 것](/나의 첫 번째 노트) 입력
...
기술 스택은 [기술 검토 메모#최종 결정](/기술 검토 메모)을 참고하세요.
...
)` 는 옵시디언을 단순 노트 앱에서 지식 그물망으로 바꾸는 핵심 기능이다.  
