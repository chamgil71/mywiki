...
---
## 연결된 노트
- [관련 아이디어 A](/관련 아이디어 A) — [어떻게 연결되는가]
- [관련 아이디어 B](/관련 아이디어 B) — [어떻게 연결되는가]
- [반대 견해를 가진 노트](/반대 견해를 가진 노트) — [어떻게 다른가]

## 출처
- [문헌 노트 이름](/문헌 노트 이름) p.xxx
- [다른 문헌](/다른 문헌) p.xxx
```
...
---
## 연결된 노트
- [딥 워크가 피상적 작업보다 더 많은 가치를 창출한다](/딥 워크가 피상적 작업보다 더 많은 가치를 창출한다) — 같은 맥락
- [번아웃은 에너지 부족이 아닌 의미 부족이다](/번아웃은 에너지 부족이 아닌 의미 부족이다) — 반대 측면
- [혁신은 계획이 아닌 놀이에서 온다](/혁신은 계획이 아닌 놀이에서 온다) — 동일 주제 다른 각도

## 출처
- [슬랙 — 톰 드마르코 독서노트](/슬랙 — 톰 드마르코 독서노트) p.47
```
...
---
## 연결된 노트
- [제텔카스텐은 외부 인지를 활용한다](/제텔카스텐은 외부 인지를 활용한다) — 확장
- [영구 노트는 단순 요약이 아닌 사고 행위다](/영구 노트는 단순 요약이 아닌 사고 행위다) — 직접 연결
- [완벽주의가 창의성을 막는다](/완벽주의가 창의성을 막는다) — 관련 장벽

## 출처
- [글쓰기란 무엇인가 — William Zinsser](/글쓰기란 무엇인가 — William Zinsser) p.12
- [제텔카스텐으로 공부하라 — 숀케 아렌스](/제텔카스텐으로 공부하라 — 숀케 아렌스) p.88
```
...
## 핵심 아이디어
1. [쓰기는 생각의 결과가 아니라 생각의 도구다](/쓰기는 생각의 결과가 아니라 생각의 도구다)
2. [간격 반복이 장기 기억의 가장 효율적인 방법이다](/간격 반복이 장기 기억의 가장 효율적인 방법이다)
3. [능동적 회상이 수동적 재독보다 3배 효과적이다](/능동적 회상이 수동적 재독보다 3배 효과적이다)
4. [연결이 없는 정보는 망각된다](/연결이 없는 정보는 망각된다)

## 방법론
- [제텔카스텐의 6가지 원칙](/제텔카스텐의 6가지 원칙)
- [PARA 방법론의 핵심](/PARA 방법론의 핵심)
- [GTD의 2분 규칙 적용법](/GTD의 2분 규칙 적용법)

## 도구
- [옵시디언이 제텔카스텐에 최적화된 이유](/옵시디언이 제텔카스텐에 최적화된 이유)
- [Anki로 간격 반복 구현하기](/Anki로 간격 반복 구현하기)

## 질문들 (탐구 중)
- [왜 배운 것의 대부분은 잊혀지는가?](/왜 배운 것의 대부분은 잊혀지는가?)
- [메타인지는 학습 효율을 얼마나 높이는가?](/메타인지는 학습 효율을 얼마나 높이는가?)

## 연관 인덱스
- [인덱스: 글쓰기와 창의성](/인덱스: 글쓰기와 창의성)
- [인덱스: 생산성과 집중](/인덱스: 생산성과 집중)
```
...
---
## 연결된 노트
- [딥 워크가 피상적 작업보다 더 많은 가치를 창출한다](/딥 워크가 피상적 작업보다 더 많은 가치를 창출한다)
- [멀티태스킹은 뇌의 전환 비용을 무시한다](/멀티태스킹은 뇌의 전환 비용을 무시한다)
- [슬랙(Slack) 시간은 창의성의 필수 조건이다](/슬랙(Slack) 시간은 창의성의 필수 조건이다)
